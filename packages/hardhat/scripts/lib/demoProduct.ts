 ...
 * IPFS libraries. The issuing laboratory is fictional — a made-up certificate
 * should not carry a real certification body's name.
 */
export const DEMO_DOCUMENT = {
  name: "declaration-of-conformity.txt",
  type: "text/plain",
  body: [
    "EU DECLARATION OF CONFORMITY",
    "Regulation (EU) 2023/1542 on batteries",
    "",
    "Product:       PowerCell 72 kWh EV Pack",
    "Manufacturer:  Northwind Cells, Gdansk Plant 2",
    "GTIN:          09506000134352",
    "Chemistry:     LFP",
    "",
    "Inspected by Example Test Laboratory. State of health 100%, no cell imbalance.",
    "",
    "Demo document generated by the product-passport scaffold-hbar template.",
    "",
  ].join("\n"),
} as const;
